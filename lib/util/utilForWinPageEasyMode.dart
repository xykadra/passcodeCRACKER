...
class UtilForWinPageEasyMode extends StatefulWidget {
  final String num1;
  final String num2;
  final String num3;
  final String num4;
  ...
  @override
  State<UtilForWinPageEasyMode> createState() => _UtilForWinPageEasyModeState();
}

class _UtilForWinPageEasyModeState extends State<UtilForWinPageEasyMode> {
